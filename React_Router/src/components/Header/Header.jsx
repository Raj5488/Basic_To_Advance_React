            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                ...
                mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        <Link
                            to="#"
                            className="text-white bg-orange-700 hover:bg- 
                            orange-800 focus:ring-4 focus:ring-orange-300 
                    ...
                    <div
                        className="hidden justify-between items-center w- 
                        full lg:flex lg:w-auto lg:order-1"
                        id="mobile-menu-2"
                    >
                        ...
                        lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                ...
                                to = "/about"
                                    className={({isActive}) =>
                                        `block py-2 pr-4            pl3                                     duration-200 ${isActive ?
            "text-orange-700" : 
            "text-gray-700"} 
            border-b
            border-gray-100
